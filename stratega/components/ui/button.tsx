...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap font-semibold ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:translate-y-[1px]",
  {
    variants: {
      variant: {
        default: "bg-[#2563EB] text-white hover:bg-[#1D4ED8] hover:-translate-y-[1px] shadow-[0_1px_2px_rgba(17,24,39,0.06)] hover:shadow-[0_8px_24px_rgba(17,24,39,0.08)]",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        outline:
          "border-2 border-foreground/20 bg-white text-foreground hover:bg-foreground/5 hover:border-foreground/30 hover:shadow-[0_1px_2px_rgba(17,24,39,0.06)] hover:-translate-y-[1px]",
        secondary:
